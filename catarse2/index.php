...
<body>
    <div id="preloader">
        <img src="img/logo2-removebg-preview.png" alt="Carregando..." class="loader-img">
    </div>
    ...
    <header id="home" class="hero">
        ...
        <a href="paginas/cadastro.html" class="cta">Reserve a sua</a>
    </header>
    ...
    <section class="destaque-produto">
        <div class="container">
            ...
            <div class="produto-info">
                ...
                <a href="paginas/produtos.php" class="cta2">Ver Produtos</a>
            </div>
        </div>
    </section>
    ...
    <section class="promocao">
        <div class="container">
            ...
            <a href="paginas/cadastro.html" class="cta1">Cadastre-se</a>
        </div>
    </section>
